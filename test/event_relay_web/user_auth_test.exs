defmodule ERWeb.UserAuthTest do
  use ERWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias ER.Accounts
  alias ERWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ERWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ERWeb.Endpoint.subscribe(live_socket_id)
