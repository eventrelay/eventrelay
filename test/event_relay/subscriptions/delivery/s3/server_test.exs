defmodule ER.Subscriptions.Delivery.S3.ServerTest do
  use ER.DataCase
  alias ER.Subscriptions.Delivery.S3.Server
  ...
  describe "jsonl_encode_delivery_events/1" do
    ...
    test "encodes events to jsonl", %{subscription: subscription, topic: topic} do
      deliveries =
