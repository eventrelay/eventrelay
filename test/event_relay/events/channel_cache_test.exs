defmodule ER.Events.ChannelCacheTest do
  ...
  describe "register_socket/3" do
    test "increases the count for a destination" do
  ...
  describe "deregister_socket/1" do
    test "decreases the count for a destination" do
      fake_pid = spawn(fn -> nil end)
  ...
  describe "any_sockets?/2" do
    test "returns true if there is a destination" do
      fake_pid = spawn(fn -> nil end)
    ...
    test "returns false if there is a destination" do
