defmodule ER.Transformers.TransformerTest do
  use ER.DataCase
  import ER.Factory
  ...
  setup do
    ...
    transformer =
      insert(:transformer,
        ...
        source: source,
        return_type: :map,
        query: "data.object.plan.object == 'plan'"
      )
  ...
  describe "matches?/2" do
    test "returns true if the query matches the provided data", %{transformer: transformer} do
      assert ER.Transformers.Transformer.matches?(transformer, payload()) == true
    end

    test "returns false if the query does not match the provided data", %{
