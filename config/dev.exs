...
config :event_relay, ERWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "twLRgzmzsj5mMN82XkznfC5n7/6Na2RckDL9/gn8SGFYDXAd1cImB/BVizg/hFmb",
  watchers: [
...
config :event_relay, ERWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/event_relay_web/(live|views)/.*(ex)$",
      ~r"lib/event_relay_web/templates/.*(eex)$"
    ]
  ]
